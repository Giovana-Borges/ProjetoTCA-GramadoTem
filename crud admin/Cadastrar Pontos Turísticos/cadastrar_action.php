...
if($nome){
    ...
    if($sql->rowCount() === 0){
        $sql = $pdo->prepare("INSERT INTO pontos_turisticos (nome, descricao, endereco, horario, telefone, preco, avaliacao, website, tipo) VALUES (:nome, :descricao, :endereco, :horario, :telefone, :preco, :avaliacao, :website, tipo)");
        $sql->bindValue(':nome', $nome);
