...
<html lang="pt-br">
	...
	<body>
		...
		?>
		<form class="modal-content modal-dialog" style=text-align:center method="POST" action="valida.php">
			<label class="btn" style=font-weight:bold>E-mail</label>
			<input class="btn" style=border-color:#116bb6 type="text" name="email" placeholder="Digite seu email"><br><br>
			
			<label class="btn" style=font-weight:bold>Senha</label>
			<input class="btn " style=border-color:#116bb6 type="password" name="senha" placeholder="Digite a sua senha"><br><br>
			
			<div style=border-size:5px>
			<input class="btn " style=border-color:#116bb6 type="submit" name="btnLogin" value="Acessar"><br><br>
			</div>

			<div style=border-size:40px>
			<h4 class="btn" style=border-color:#116bb6>Você ainda não possui uma conta?
			<a href="cadastrar.php">Crie grátis</a></h4><br>
		    </div>

			<div style=border-size:40px>
			<h4 class="btn" style=border-color:#116bb6>Deseja fazer alterações?
			<a href="admin/login_admin.php">Acesse como administrador</a></h4><br>
		    </div>
