          ...
          <form>
            ...
            <div class="form-group">
              <label for="formGroupExampleInput">
                ...
                <div class="paragrafo">
                <p></p>
                <p>Endereço: <?= $ar_livre['endereco']?></p>
                <p>Avaliação: <?= $ar_livre['avaliacao']?></p>
                <p>Horário de Funcionamento: <?= $ar_livre['horario']?></p>
                <p>Contato: <?= $ar_livre['telefone']?></p>
                <p>Média de Preços: <?= $ar_livre['preco']?></p>
